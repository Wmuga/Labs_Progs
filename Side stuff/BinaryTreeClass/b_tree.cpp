...
typename binary_tree<TypeValue>::Node *binary_tree<TypeValue>::create_Node() {
    return create_Node(TypeValue());
}

template<class TypeValue>
typename binary_tree<TypeValue>::Node *binary_tree<TypeValue>::create_Node(TypeValue _value) {
...
template<class TypeValue>
void binary_tree<TypeValue>::insert(Node** place,TypeValue _value) {
    if ((*place)== nullptr) (*place)=create_Node(_value);
