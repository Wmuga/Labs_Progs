...
begin
  ...
  writeln(out_data,'---------------------------------------------------------------');
  if (min_value<0) then Writeln(out_data,'Íåò òàêîãî ıëåìåíòà ìàññèâà À, êîòîğûé óäîâëåòâîğÿë çàäàííûì óñëîâèÿì')
  else writeln(out_data,'Ìèíèìàëüíûé ıëåìåíò ìàññèâà À, óäîâëåòâîğÿşùèé óñëîâèå ğàâåí ',min_value);
  CloseFile(out_data);
end;
